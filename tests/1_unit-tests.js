...
suite("Unit Tests", () => {
  suite("American to British English", () => {
    test("Mangoes are my favorite fruit. --> Mangoes are my favourite fruit.", (done) => {
      ...
      assert.equal(translator.toBritishEnglish(input)[0], output);
  ...
  suite("British to American English", () => {
    test("We watched the footie match for a while. --> We watched the soccer match for a while.", (done) => {
      ...
      assert.equal(translator.toAmericanEnglish(input)[0], output);
      done();
    });
  ...
  suite("Highlight Translation", () => {
    test("Mangoes are my favorite fruit.", (done) => {
      ...
      assert.equal(translator.toBritishEnglish(input)[1], output);
      done();
    });
    ...
    test("We watched the footie match for a while.", (done) => {
      ...
      assert.equal(translator.toAmericanEnglish(input)[1], output);
      done();
    });

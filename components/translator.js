...
class Translator {
  ...
  translate(text, dict, titles, timeRegex, locale) {
    ...
    // Search for title and add'em to the matchesMap object
    ...
    // Filter words with spaces from current directory
    const wordsWithSpace = Object.fromEntries(
      Object.entries(dict).filter(([k, v]) => k.includes(" ")),
    );

    //Search for spaced word matches and add'em to matchesMap object
    ...
    //Search for indivdual word matches and add'em to the matchesMap object
